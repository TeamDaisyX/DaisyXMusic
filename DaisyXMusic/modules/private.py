...
@Client.on_message(filters.private & filters.incoming & filters.command(['m_start']))
...
@Client.on_message(filters.command("m_start") & ~filters.private & ~filters.channel)
...
@Client.on_message(filters.private & filters.incoming & filters.command(['m_help']))
...
@Client.on_message(filters.command("m_help") & ~filters.private & ~filters.channel)
