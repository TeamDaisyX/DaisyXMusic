...
def map(pos):
    if(pos==1):
        ...
        button = [
            ...
            [InlineKeyboardButton(text = '📌Channel', url=f"https://t.me/kpoppsongcover" ),
             InlineKeyboardButton(text = 'My group', url=f"https://t.me/nyanyiisinii" )],
            [InlineKeyboardButton(text = 'Owner', url=f"https://t.me/rizexx" )],
...
async def ghelp(_, message: Message):
    await message.reply_text(
        f"""**✨Hii aku 𝙧𝙞𝙯𝙚𝙭 𝙢𝙪𝙨𝙞𝙘 dapat memutar musik di grup ataupun di channel kamu.**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
