...
async def play(_, message: Message):
           ...
           for administrator in administrators:
                      if administrator == message.from_user.id:  
                          ...
                          try:
                              ...
                              await lel.edit(
                                  "<b>helper userbot berhasil bergabung ke obrolan</b>",
                              )
    ...
    try:
        ...
        await lel.edit(
            f"<i> {user.first_name} Userbot tidak ada dalam grup ini, Minta admin untuk tambahkan Asisstant {user.first_name} secara manual</i>"
        )
        return     
...
async def deezer(client: Client, message_: Message):
    ...
    try:
        ...
        await lel.edit(
            f"<i> {user.first_name} Userbot tidak bisa bergabung ke Vcg, lakukan admin dengan kirim /play dan masukkan ke grup atau tunggu beberapa menit masukan lagi{user.first_name} manually</i>"
        )
        return                            
    ...
    if message_.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        appendable = [s_name, r_by, loc]
        qeue.append(appendable)
        await res.edit_text(f"✯IRWAN✯= #️⃣ Lagu yang anda minta **Sedang Antri** di posisi{position}")
    else:
...
async def jiosaavn(client: Client, message_: Message):
    ...
    if message_.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        m = await client.send_photo(
            ...
            reply_markup=keyboard,
            photo="final.png",
            caption=f"✯IRWAN✯=#️⃣ Lagu yang Anda minta **Sedang Antri** di posisi {position}",
